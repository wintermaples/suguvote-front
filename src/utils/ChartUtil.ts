...
export function planningChartBackgroundColorScheme(typeNum: number): string[] {
    const colors: string[] = [];
    for (let i = 0; i < typeNum; i++) {
        colors.push(hslToRgb(Math.min(1, (1.0 / typeNum) * i), CHART_BG_COLOR_SATURATION, CHART_BG_COLOR_LIGHTNESS));
    }
